...
library(caret)
rm(list = ls())
setwd("D:/OR/Churn/machine logs")
# Load some data into the workspace 

text_raw1= read.csv('alert_edw01t2.log.old.20170717.csv',header=TRUE)
...
tuned_lda_model <- FitLdaModel(dtm = cosmos_dtm, k = 25, iterations = 5000)
