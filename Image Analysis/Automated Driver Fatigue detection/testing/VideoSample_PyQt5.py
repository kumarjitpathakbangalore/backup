...
class ControlWindow(QtWidgets.QMainWindow):
    ...
    def loadPosMatFile(self):
        try:
            self.matPosFileName = str(QtWidgets.QFileDialog.getOpenFileName(self, 'Select .mat position File'))[0]
    ...
    def loadVideoFile(self):
        try:
            self.videoFileName = QtWidgets.QFileDialog.getOpenFileName(self, 'Select .h264 Video File')[0]
